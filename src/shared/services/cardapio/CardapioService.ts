...
const getAll = async (pagina:number, qtdregs:number, totpags:number, filter:string): Promise<Cardapio[] | Error>  => {
    try {
        let str_json = "";
        let filtros = "";
        ...
        str_json += "\"classe\":\"\",";
        str_json += "\"metodo\":\"\",";
        str_json += "\"procedure\":\"p_sel_empresa\",";
        str_json += "\"parametros\":[";
        str_json += filtros;
        str_json += "]";
        str_json += "}"
...
const getById = async (): Promise<Cardapio[] | Error> => {
    try {
        let str_json = "";
        let filtros = "";
